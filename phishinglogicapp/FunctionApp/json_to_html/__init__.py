...
def create_html(json_data):
    ...
    <body>
    {% set section_order = ['final_assessment', 'email_summary', 'pretense_vs_intent_mapping', 'intent_verification', 'logical_coherence', 'behavioral_triggers', 'url_analysis', 'attachment_analysis'] %}
